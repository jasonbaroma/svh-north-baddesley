    ...
    <div className="flex min-h-screen flex-col">
          ...
          <div className="relative z-10 grid gap-12 lg:grid-cols-[1fr_420px] lg:items-center">
            <div className="max-w-3xl">
              <div className="flex flex-col gap-6">
                ...
                <p className="text-xl text-green-100">{"{{LOCATION1_HERO_SUBTITLE}}"}</p>
      ...
      <section className="bg-white px-6 py-20 text-slate-950">
        <div className="mx-auto grid max-w-6xl gap-12 lg:grid-cols-[1.1fr_0.9fr] lg:items-center">
          <div>
            <p className="mb-4 text-sm font-semibold uppercase tracking-[0.3em] text-[#17a24a]">{"{{LOCATION1_FEATURE_SECTION_KICKER}}"}</p>
      ...
      <section className="bg-white px-6 py-20">
        <div className="mx-auto max-w-5xl text-center">
          <p className="mb-4 text-sm font-semibold uppercase tracking-[0.3em] text-[#17a24a]">{"{{LOCATION1_CONTENT_SECTION_KICKER}}"}</p>
      ...
      <section id="benefits" className="relative overflow-hidden bg-gradient-to-b from-slate-50 to-white px-6 py-20">
        ...
        <div className="mx-auto max-w-6xl">
          <div className="mx-auto mb-14 max-w-3xl text-center">
            <p className="mb-4 text-sm font-semibold uppercase tracking-[0.3em] text-[#17a24a]">{"{{LOCATION1_BENEFITS_SECTION_KICKER}}"}</p>
      ...
      <section className="bg-white px-6 py-20">
        <div className="mx-auto max-w-5xl">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <h2 className="text-3xl font-bold tracking-tight text-slate-950 md:text-4xl">{"{{LOCATION1_INFO_CONTENT_SECTION_TITLE}}"}</h2>
            <p className="mt-4 text-lg leading-8 text-slate-600">{"{{LOCATION1_INFO_CONTENT_SECTION_INTRO}}"}</p>
          </div>
      ...
      <section className="bg-white px-6 py-20">
        <div className="mx-auto max-w-4xl">
          <div className="mb-12 text-center">
            <p className="mb-4 text-sm font-semibold uppercase tracking-[0.3em] text-[#17a24a]">{"{{LOCATION1_FAQ_SECTION_KICKER}}"}</p>
      ...
      <section className="bg-[#17a24a] px-6 py-16 text-center text-white">
        <div className="mx-auto max-w-2xl">
          ...
          <p className="mb-8 text-lg text-green-100">{"{{LOCATION1_CTA_DESCRIPTION}}"}</p>
